"""Infrastructure for tournament that can change between minimax and minimax alpha beta prune.
...
class Tournament(object):
  ...
  """
    ...
    def run(self, student_strategies: dict, increasing_depth: bool = True, n_pairs: int = 1, allow_selfmatch: bool = False, strategy_sel: MinimaxStrategy = MinimaxStrategy) -> Tuple[dict, dict, dict]:
        scores = dict()
        totals = dict()
        name_mapping = dict()
                        ...
                        for pair in range(2*n_pairs):
                            ...
                            if increasing_depth:
                                for depth in range(1, self.__max_depth):
                                    pl1 = Player(
                                        name=name1,
                                        strategy=strategy_sel(  # MinimaxAlphaBetaStrategy(
                                            heuristic=Heuristic(
